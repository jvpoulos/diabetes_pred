...
$ python3 src/train.py --model_type FTTransformer --dim 512 --depth 6 --attn_dropout 0.1 --outcome 'A1cGreaterThan7' --batch_size 8 --learning_rate 0.1 --epochs 25 --early_stopping_patience 10 --use_cutmix --model_path 'model_weights/FTTransformer_dim512_adr0.1_A1cGreaterThan7_bs8_lr0.01_ep14_esp10_cmp0.3_cml10_umfalse_ma0.2_uctrue_best.pth' 
