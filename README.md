...
$ python3 src/train.py --model_type FTTransformer --dim 128 --attn_dropout 0.1 --outcome 'A1cGreaterThan7' --batch_size 16 --epochs 200 --early_stopping_patience 15 --use_cutmix --cutmix_prob 0.2 --cutmix_alpha 1 --run_id '8zthc8tx' --wandb_path 'model_weights/FTTransformer_dim128_dim3_heads8_fdr0.1_adr0.2_A1cGreaterThan7_bs16_lr0.001_ep21_esp15_cmp0.2_cml1.0_umfalse_ma0.2_uctrue_best.pth' 
```
